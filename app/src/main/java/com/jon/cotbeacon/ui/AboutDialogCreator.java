...
import com.jon.cotbeacon.updating.JsonRelease;
import com.jon.cotbeacon.updating.UpdateChecker;
...
class AboutDialogCreator {
    ...
    private static final List<Line> DATA = Arrays.asList(
            ...
            new Line("Github Repository", "https://github.com/jonapoul/cotbeacon", R.drawable.go_to)
    );
